...
map2 <- read_rds("../00_data/fig/map2.rds")
amenities_fig          <- read_rds("../00_data/fig/amenities_fig.rds")
tours_fig              <- read_rds("../00_data/fig/tours_fig.rds")
amen_tour_by_state_fig <- read_rds("../00_data/fig/amen_tour_by_state_fig.rds")
tour_types_fig         <- read_rds("../00_data/fig/tour_types_fig.rds")
tour_types_heatmap_fig <- read_rds("../00_data/fig/tour_types_heatmap_fig.rds")
```
