...
The interactive nature of the map provides further functionality. Operators can zoom in on specific regions or cities by clicking on the plus sign, '+', located in the upper right corner of the map. This zoom feature is particularly useful when examining ATV tours in Hawaii, where many tours focus on small areas with unique terrain and natural features. By zooming in, operators can gain a deeper understanding and evaluation of the ATV tours available in Hawaii. Please click the reset button to revert the map back to its original state.
...
```{r fig.height=10, echo=FALSE, warning=FALSE, message=FALSE, out.width="100%"}
